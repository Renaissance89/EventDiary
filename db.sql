...
('adwait', 'patil', 'adwait@test.com', 'test', 614543532, 'sangli', 'maharashtra', 'Male', 'user', '0'),
('sonali', 'bhapkar', 'sonali@test.com', 'test', 916424487, 'satara', 'maharashtra', 'Female', 'user', '0'),
('soniya', 'patil', 'soniya@test.com', 'test', 982568936, 'kalyan', 'maharashtra', 'Female', 'organizer', '0');
